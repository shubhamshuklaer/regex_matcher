try:
    ...
    print ("Missing Dependency Error: %s. Tkinter library is required for using the GUI.") % err.message
    sys.exit(1)
...
if dotFound:
    try:
        ...
        print ("Missing Dependency Error: %s. The PIL library is required for displaying the graphs.") % err.message
        dotFound = False
else:
    print "Missing Dependency Error: The GraphViz software is required for displaying the graphs."
...
class gui:
    ...
    def initUI(self):
        self.root.title("Regex --> Automata")
        ...
        self.bottomLabel = Label(parentFrame, text="Regex Analyzer")
